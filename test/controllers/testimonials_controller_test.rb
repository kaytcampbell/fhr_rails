...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { author: @testimonial.author, body: @testimonial.body, location: @testimonial.location } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { author: @testimonial.author, body: @testimonial.body, location: @testimonial.location } }
